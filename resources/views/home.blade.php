...
<head>
    ...
    <title>Электровелосипеды под ключ</title>

    <meta name="keywords" content="HTML5 Template">
    <meta name="description" content="Porto - Responsive HTML5 Template">
    <meta name="author" content="bessmertniy">
...
<div class="body">
    <header id="header" class="header-transparent header-effect-shrink header-no-border-bottom" data-plugin-options="{'stickyEnabled': true, 'stickyEffect': 'shrink', 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': true, 'stickyStartAt': 70, 'stickyChangeLogo': false, 'stickyHeaderContainerHeight': 70}" style="height: 100px;">
    ...
    <div role="main" class="main">
        ...
        <section class="section border-0 section-dark section-angled section-angled-reverse section-funnel m-0 position-relative overflow-visible lazyloaded" style="background-image: url(&quot;img/landing/porto_performance_bg.png&quot;); background-size: 100%; background-position: center top; background-repeat: no-repeat;" data-bg-src="img/landing/porto_performance_bg.png">
            ...
            <img class="img-fluid position-absolute d-none d-lg-block appear-animation lazyloaded animated appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300" data-appear-animation-duration="750" src="img/landing/porto_notebook.png" data-src="img/landing/porto_notebook.png" alt="Performance on Laptop" style="display: block; top: -170px; left: 90px;">
            <div class="container text-center py-5 mb-5">
                <div class="row justify-content-center pb-md-5 mb-md-5">
                    <div class="col-md-7 offset-lg-5 pb-md-5 mb-md-5">
                        <h2 class="font-weight-bold text-9 appear-animation mb-3 animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750" style="animation-delay: 200ms;">Top Performance</h2>
                        <p class="custom-text-color-1 color-inherit mb-4 pb-lg-2 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400" data-appear-animation-duration="750" style="animation-delay: 400ms;">Porto has high performance base, all structure are focusing on performance as main point. Porto speed optimization is super fast compared to other templates.</p>
                    </div>
                </div>
                <div class="row align-items-center pb-md-5 mb-md-5">
                    <div class="col-12 col-md-7 text-center mt-5">
                        <h2 class="font-weight-bold text-7 text-md-6 text-lg-9 pt-5 pt-md-4 mt-5 mb-lg-3 mb-2 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750" style="animation-delay: 200ms;">Works Perfectly on <span class="highlighted-word highlighted-word-animation-1 highlighted-word-animation-1-no-rotate alternative-font-4 font-weight-bold"> Any </span> Device!</h2>
                        <p class="custom-text-color-1 color-inherit appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400" data-appear-animation-duration="750" style="animation-delay: 400ms;">We believe you will face lots of traffic from mobile device users not only from desktop or laptop users. Porto is the best solution for you, works fine on any screen resolutions and mobile devices. Try Porto and see how it works!</p>
                    </div>
                    <div class="col-5 d-none d-md-block">
                        <div class="text-right mr-3 mr-lg-5 ml-auto mb-4 appear-animation animated fadeInLeftShorter appear-animation-visible" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="600" data-appear-animation-duration="750" style="max-width: 244px; animation-delay: 600ms;" data-plugin-options="{'accY': -100}">
                            <img class="img-fluid lazyloaded" src="img/landing/porto_iphone.png" data-src="img/landing/porto_iphone.png" width="244" height="228" alt="Performance on Mobile">
                        </div>
                        <img class="img-fluid appear-animation z-index-1 position-relative animated fadeInRightShorter appear-animation-visible lazyloaded" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="800" data-appear-animation-duration="750" src="img/landing/porto_ipad.png" data-src="img/landing/porto_ipad.png" width="437" height="241" alt="Performance on Tablet" style="margin-bottom: -10%; animation-delay: 800ms;">
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row align-items-center appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="250" data-appear-animation-duration="750" style="animation-delay: 250ms;">
                    <div class="col-lg-8 offset-lg-2 text-center">
                        ...
                        <p class="text-4 mb-5 appear-animation animated appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400" data-appear-animation-duration="750">Porto is a truely complete template, with over 80 demos that make it suitable for any type of website. We believe you will like Porto.</p>
                        <p class="d-flex align-items-center justify-content-center font-weight-bold text-color-dark text-8 negative-ls-1 pb-3 mb-4 appear-animation animated appear-animation-visible" data-appear-animation="blurIn" data-appear-animation-delay="600"><span class="highlighted-word highlighted-word-animation-1 highlighted-word-animation-1-2 highlighted-word-animation-1-2-dark highlighted-word-animation-1 highlighted-word-animation-1-no-rotate alternative-font-4 font-weight-extra-bold line-height-1 text-9 mr-3">80+</span> Demos Ready to Use</p>
                    </div>
                </div>
            </div>
            <div class="container-fluid">
                <div class="py-4 bg-light left-0 z-index-3 w-100" data-plugin-sticky="" data-plugin-options="{'minWidth': 991, 'padding': {'top': 70}}">
                    <div class="text-center appear-animation animated fadeIn appear-animation-visible" data-appear-animation="fadeIn" data-appear-animation-delay="400" data-appear-animation-duration="750" style="animation-delay: 400ms;">
                ...
                <div class="row portfolio-list sort-destination sort-destination-margin sort-destination-items-hardware-acc overflow-visible mt-4" data-sort-id="portfolio" data-filter="*" style="position: relative; height: 6265.46px;">
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item classic" style="position: absolute; left: 0px; top: 0px;">
                        <div class="appear-animation animated appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-classic.jpg" style="background-image: url(&quot;img/previews/preview-classic.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item onepage" style="position: absolute; left: 256.266px; top: 0px;">
                        <div class="appear-animation animated appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-one-page.jpg" style="background-image: url(&quot;img/previews/preview-one-page.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 512.532px; top: 0px;">
                        <div class="appear-animation animated appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate.jpg" style="background-image: url(&quot;img/previews/preview-corporate.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 0px; top: 231.906px;">
                        <div class="appear-animation animated appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-2.jpg" style="background-image: url(&quot;img/previews/preview-corporate-2.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 256.266px; top: 231.906px;">
                        <div class="appear-animation animated appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-3.jpg" style="background-image: url(&quot;img/previews/preview-corporate-3.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 512.532px; top: 231.906px;">
                        <div class="appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750" style="animation-delay: 200ms;">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-4.jpg" style="background-image: url(&quot;img/previews/preview-corporate-4.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 0px; top: 463.812px;">
                        <div class="appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750" style="animation-delay: 200ms;">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-5.jpg" style="background-image: url(&quot;img/previews/preview-corporate-5.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 256.266px; top: 463.812px;">
                        <div class="appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750" style="animation-delay: 200ms;">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-6.jpg" style="background-image: url(&quot;img/previews/preview-corporate-6.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 512.532px; top: 463.812px;">
                        <div class="appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750" style="animation-delay: 200ms;">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-7.jpg" style="background-image: url(&quot;img/previews/preview-corporate-7.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 0px; top: 695.718px;">
                        <div class="appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750" style="animation-delay: 200ms;">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-8.jpg" style="background-image: url(&quot;img/previews/preview-corporate-8.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 256.266px; top: 695.718px;">
                        <div class="appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750" style="animation-delay: 200ms;">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-9.jpg" style="background-image: url(&quot;img/previews/preview-corporate-9.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 512.532px; top: 695.718px;">
                        <div class="appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750" style="animation-delay: 200ms;">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-10.jpg" style="background-image: url(&quot;img/previews/preview-corporate-10.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 0px; top: 927.624px;">
                        <div class="appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750" style="animation-delay: 200ms;">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-11.jpg" style="background-image: url(&quot;img/previews/preview-corporate-11.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 256.266px; top: 927.624px;">
                        <div class="appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750" style="animation-delay: 200ms;">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-12.jpg" style="background-image: url(&quot;img/previews/preview-corporate-12.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 512.532px; top: 927.624px;">
                        <div class="appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750" style="animation-delay: 200ms;">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-13.jpg" style="background-image: url(&quot;img/previews/preview-corporate-13.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 0px; top: 1159.53px;">
                        <div class="appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750" style="animation-delay: 200ms;">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-14.jpg" style="background-image: url(&quot;img/previews/preview-corporate-14.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 256.266px; top: 1159.53px;">
                        <div class="appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750" style="animation-delay: 200ms;">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-15.jpg" style="background-image: url(&quot;img/previews/preview-corporate-15.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 512.532px; top: 1159.53px;">
                        <div class="appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750" style="animation-delay: 200ms;">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-16.jpg" style="background-image: url(&quot;img/previews/preview-corporate-16.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 0px; top: 1391.44px;">
                        <div class="appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750" style="animation-delay: 200ms;">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-17.jpg" style="background-image: url(&quot;img/previews/preview-corporate-17.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 256.266px; top: 1391.44px;">
                        <div class="appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750" style="animation-delay: 200ms;">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-18.jpg" style="background-image: url(&quot;img/previews/preview-corporate-18.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 512.532px; top: 1391.44px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-19.jpg" style="background-image: url(&quot;img/previews/preview-corporate-19.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 0px; top: 1623.34px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-20.jpg" style="background-image: url(&quot;img/previews/preview-corporate-20.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item portfolio" style="position: absolute; left: 256.266px; top: 1623.34px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-portfolio.jpg" style="background-image: url(&quot;img/previews/preview-portfolio.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item portfolio" style="position: absolute; left: 512.532px; top: 1623.34px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-portfolio-2.jpg" style="background-image: url(&quot;img/previews/preview-portfolio-2.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item portfolio" style="position: absolute; left: 0px; top: 1855.25px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-portfolio-3.jpg" style="background-image: url(&quot;img/previews/preview-portfolio-3.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item portfolio" style="position: absolute; left: 256.266px; top: 1855.25px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-portfolio-4.jpg" style="background-image: url(&quot;img/previews/preview-portfolio-4.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item portfolio" style="position: absolute; left: 512.532px; top: 1855.25px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-portfolio-5.jpg" style="background-image: url(&quot;img/previews/preview-portfolio-5.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item blog" style="position: absolute; left: 0px; top: 2087.15px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-blog.jpg" style="background-image: url(&quot;img/previews/preview-blog.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item blog" style="position: absolute; left: 256.266px; top: 2087.15px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-blog-2.jpg" style="background-image: url(&quot;img/previews/preview-blog-2.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item blog" style="position: absolute; left: 512.532px; top: 2087.15px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-blog-3.jpg" style="background-image: url(&quot;img/previews/preview-blog-3.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item blog" style="position: absolute; left: 0px; top: 2319.06px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-blog-4.jpg" style="background-image: url(&quot;img/previews/preview-blog-4.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item blog" style="position: absolute; left: 256.266px; top: 2319.06px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-blog-5.jpg" style="background-image: url(&quot;img/previews/preview-blog-5.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 512.532px; top: 2319.06px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-corporate-hosting.jpg" style="background-image: url(&quot;img/previews/preview-corporate-hosting.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item classic" style="position: absolute; left: 0px; top: 2550.97px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-classic-color.jpg" style="background-image: url(&quot;img/previews/preview-classic-color.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item classic" style="position: absolute; left: 256.266px; top: 2550.97px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0 lazyloaded" data-bg-src="img/previews/preview-classic-light.jpg" style="background-image: url(&quot;img/previews/preview-classic-light.jpg&quot;);">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item classic" style="position: absolute; left: 512.532px; top: 2550.97px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item classic" style="position: absolute; left: 0px; top: 2782.87px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 256.266px; top: 2782.87px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 512.532px; top: 2782.87px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 0px; top: 3014.78px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 256.266px; top: 3014.78px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business new" style="position: absolute; left: 512.532px; top: 3014.78px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 0px; top: 3246.68px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 256.266px; top: 3246.68px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business new" style="position: absolute; left: 512.532px; top: 3246.68px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center portfolio-item-new">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 0px; top: 3478.59px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 256.266px; top: 3478.59px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 512.532px; top: 3478.59px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 0px; top: 3710.5px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 256.266px; top: 3710.5px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 512.532px; top: 3710.5px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 0px; top: 3942.4px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item shop" style="position: absolute; left: 256.266px; top: 3942.4px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 512.532px; top: 3942.4px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 0px; top: 4174.31px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 256.266px; top: 4174.31px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business new" style="position: absolute; left: 512.532px; top: 4174.31px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center portfolio-item-new">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 0px; top: 4406.21px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 256.266px; top: 4406.21px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 512.532px; top: 4406.21px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 0px; top: 4638.12px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 256.266px; top: 4638.12px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 512.532px; top: 4638.12px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 0px; top: 4870.03px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business new" style="position: absolute; left: 256.266px; top: 4870.03px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center portfolio-item-new">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item onepage" style="position: absolute; left: 512.532px; top: 4870.03px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item portfolio creative" style="position: absolute; left: 0px; top: 5101.93px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 256.266px; top: 5101.93px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 512.532px; top: 5101.93px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item creative business" style="position: absolute; left: 0px; top: 5337.84px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 256.266px; top: 5337.84px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 512.532px; top: 5337.84px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item onepage creative business" style="position: absolute; left: 0px; top: 5569.74px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item onepage creative" style="position: absolute; left: 256.266px; top: 5569.74px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item portfolio" style="position: absolute; left: 512.532px; top: 5569.74px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item portfolio" style="position: absolute; left: 0px; top: 5801.65px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item portfolio" style="position: absolute; left: 256.266px; top: 5801.65px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 512.532px; top: 5801.65px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item business" style="position: absolute; left: 0px; top: 6033.56px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item classic" style="position: absolute; left: 256.266px; top: 6033.56px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item classic" style="position: absolute; left: 512.532px; top: 6033.56px;">
                        <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                            <div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                ...
                <div class="row flex-column flex-lg-row justify-content-center align-items-center my-5">
                    ...
                    <div class="col-8 col-md-5 col-lg-3 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000" data-appear-animation-duration="750">
                        <div class="image mb-3">
                            ...
                            <img alt="Sliders" width="142" height="161" src="img/lazy.png" data-src="img/landing/porto_sliders3.png" class="position-relative z-index-3 lazyload ml-auto" style="margin-right: 15%; margin-top: -41%;">
...
<a class="style-switcher-open-loader" href="#" data-base-path="" data-skin-src="" data-toggle="tooltip" data-placement="right" title="" data-original-title="Style Switcher"><i class="fas fa-cogs"></i><div class="style-switcher-tooltip"><strong>Style Switcher</strong><p>Check out different color options and styles.</p></div></a>		<!-- Vendor -->		<script src="vendor/jquery/jquery.min.js"></script>		<script src="vendor/jquery.appear/jquery.appear.min.js"></script>		<script src="vendor/jquery.easing/jquery.easing.min.js"></script>		<script src="vendor/jquery.cookie/jquery.cookie.min.js"></script>		<script src="vendor/popper/umd/popper.min.js"></script>		<script src="vendor/bootstrap/js/bootstrap.min.js"></script>		<script src="vendor/jquery.validation/jquery.validate.min.js"></script>		<script src="vendor/jquery.easy-pie-chart/jquery.easypiechart.min.js"></script>		<script src="vendor/jquery.gmap/jquery.gmap.min.js"></script>		<script src="vendor/lazysizes/lazysizes.min.js"></script>		<script src="vendor/isotope/jquery.isotope.min.js"></script>		<script src="vendor/owl.carousel/owl.carousel.min.js"></script>		<script src="vendor/magnific-popup/jquery.magnific-popup.min.js"></script>		<script src="vendor/vide/jquery.vide.min.js"></script>		<script src="vendor/vivus/vivus.min.js"></script>

<!-- Theme Base, Components and Settings -->		<script src="js/theme.js"></script>


<a class="envato-buy-redirect" href="https://themeforest.net/checkout/from_item/4106987?license=regular&amp;support=bundle_6month&amp;ref=Okler" target="_blank" data-toggle="tooltip" data-placement="right" title="" data-original-title="Buy Porto"><i class="fas fa-shopping-cart"></i></a>
<a class="demos-redirect" href="index.html#demos" data-toggle="tooltip" data-placement="right" title="" data-original-title="Demos"><img src="img/icons/demos-redirect.png" class="img-fluid"></a>



<!-- Theme Initialization Files -->
<script src="js/theme.init.js"></script><a class="scroll-to-top hidden-mobile" href="#"><i class="fas fa-chevron-up"></i></a>
